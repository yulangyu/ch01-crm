...
/*String fullname = request.getParameter("fullname"); ==《param.fullname》大括号换成小括号
String id = request.getParameter("id");
String appellation = request.getParameter("appellation");
String company = request.getParameter("company");
String owner = request.getParameter("owner");   取值用《%=owner%》大括号换成小括号*/
%>
...
<script type="text/javascript">
	$(function(){
		...
		//为提交市场活动按钮绑定事件，填充市场活动源（市场活动名字和id）
		...
		$("#convertBtn").click(function(){
			...
			发送传统请求
			请求结束后，最终响应到线索列表页
            根据“为客户创建交易”是否打钩，来判断是否需要创建交易
			*/
			if($("#isCreateTransaction").prop("checked")){

				//window.location.href="workbench/clue/convertAndAddTran.do?clueId=${param.id}&money=&expectedDate=&name=&stage=&activityId=";
				//alert("需要创建交易");
				$("#tranForm").submit();
			}else{
				//alert("不需要");
